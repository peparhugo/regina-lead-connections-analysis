...
- CT geometry join coverage: **54 / 54 CTs (100%)**
- Crosswalk ledger: `reports/ct_geometry_crosswalk_2026-03-06.csv` (5 surrogate geometry mappings)
...
4. Import preset config: `reports/kepler_config_phase_a_2026-03-06.json` (or load manually then export over it).
